        ...
        },
        {
            ...
            render: processed => {
                return <Space direction="horizontal">
                    <CheckOutlined/>
                    <Badge count={processed} overflowCount={9999999} style={{backgroundColor: '#21ccaf', color: '#333'}} showZero/>
                </Space>
            },
        },
        {
            ...
            render: active => {
                return <Space direction="horizontal">
                    <LoadingOutlined/>
                    <Badge count={active} overflowCount={9999999} style={{backgroundColor: '#adc6ff', color: '#333'}} showZero/>
                </Space>
            },
        },
        {
