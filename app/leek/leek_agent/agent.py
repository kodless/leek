...
from leek.leek_agent.logger import get_logger
from leek.leek_agent.consumer import LeekConsumer
    ...
    def load_subscriptions():
        ...
        if not subscriptions:
            ...
            if not subscriptions_file:
                subscriptions_file = "/opt/app/leek/leek_agent/config/default-subscriptions.json"
