    ...
    return (
        <>
            ...
            {agent && agent.type === "standalone" &&
                <Row justify="center" align="middle" style={{width:"100%", minHeight: "calc(100vh - 100px)"}}>
                    <div>
                        <Row justify="center" style={{width:"100%"}}>
                            <Typography.Title code level={3}>AGENT IS NOT LOCAL</Typography.Title>
                        </Row>
                        <Row justify="center" style={{width:"100%"}}>
                            <Typography.Text>There is no local agent deployed with the API. Leek API cannot control standalone agents</Typography.Text>
                        </Row>
                        <Row justify="center" style={{width:"100%"}}>
                            <Typography.Text>
                                <a href="https://tryleek.com/docs/getting-started/agent" target="_blank" rel="noopener norefferer">
                                    More info
                                </a>
                            </Typography.Text>
                        </Row>
