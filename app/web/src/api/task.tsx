...
export function getFilterQuery(app_env: string | undefined, filters: TaskFilters, ) {
    ...
    let f = [
        ...
        filters.traceback && {"wildcard": {"traceback": {"value": filters.traceback, "case_insensitive": true,}}},
        filters.args && {"wildcard": {"args": {"value": filters.args, "case_insensitive": true,}}},
        filters.kwargs && {"wildcard": {"kwargs": {"value": filters.kwargs, "case_insensitive": true,}}},
        filters.result && {"wildcard": {"result": {"value": filters.result, "case_insensitive": true,}}},
